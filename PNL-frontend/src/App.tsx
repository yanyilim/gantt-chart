...
import './css/App.scss';
import ProjectListing from 'pages/Authentication/Project/ProjectListing';
...
const App = (props: any) => {
    ...
    const routes = [{ parent: 'Home', label: 'Home', parent_url: 'Home', label_url: 'Home' }];
        ...
        <div className={layoutClassName} onClick={onDocumentClick}>
            ...
            <div className="layout-main">
                ...
                <div className="layout-main-content">
                    <Routes>
                        <Route path="/Home" element={<ProjectListing />} />
                    </Routes>
                </div>
